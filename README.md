...
- Abstract, paper teaser, sensor design, training stages, discussion, and limitations.
...
Browser validation covers desktop/mobile overflow, results controls, stage controls, every ID/OOD selector, tactile seeking, comparison playback, image loading, and absence of external requests.
