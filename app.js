'use strict';
const tasks=[{name:'Box reorientation',conditions:['ID','OOD-1'],notes:['Training object','2.8× heavier'],indices:[0,1],images:['box-id','box-ood1']},{name:'Cup picking',conditions:['ID','OOD-1','OOD-2'],notes:['Training object','Square base','Stack 21 mm higher'],indices:[2,3,4],images:['cup-id',null,null]},{name:'Plug insertion',conditions:['ID','OOD-1','OOD-2'],notes:['Training object','109 g heavier','25% shorter'],indices:[5,6,7],images:['plug-id','plug-ood1','plug-ood2']}];
